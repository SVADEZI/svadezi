...
```
"./.claude/skills/seo/bin/claude-seo" run dataforseo_costs.py check <endpoint> [--count N]
```
...
```
"./.claude/skills/seo/bin/claude-seo" run dataforseo_costs.py log <endpoint> <actual_cost>
```
