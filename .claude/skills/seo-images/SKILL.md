...
"./.claude/skills/seo/bin/claude-seo" run iptc_ai_label.py audit ./images/ --json

# Audit a single image
"./.claude/skills/seo/bin/claude-seo" run iptc_ai_label.py audit ./hero.webp --json

# Inject the AI label into an image
"./.claude/skills/seo/bin/claude-seo" run iptc_ai_label.py inject ./ai-hero.webp \
