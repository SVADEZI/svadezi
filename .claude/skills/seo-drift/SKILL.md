...
**Execution:**
```bash
"./.claude/skills/seo/bin/claude-seo" run drift_baseline.py <url>
"./.claude/skills/seo/bin/claude-seo" run drift_baseline.py <url> --skip-cwv
```
...
"./.claude/skills/seo/bin/claude-seo" run drift_compare.py <url> --baseline-id 5
"./.claude/skills/seo/bin/claude-seo" run drift_compare.py <url> --skip-cwv
```
...
```bash
"./.claude/skills/seo/bin/claude-seo" run drift_report.py <comparison_json_file> --output drift-report.html
```
...
**Execution:**
```bash
"./.claude/skills/seo/bin/claude-seo" run drift_history.py <url>
"./.claude/skills/seo/bin/claude-seo" run drift_history.py <url> --limit 10
```
