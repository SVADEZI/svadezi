...
2. Use `"./.claude/skills/seo/bin/claude-seo" run render_page.py <URL> --mode auto --json` before HTML/source inspection so SPA content is visible when needed
...
"./.claude/skills/seo/bin/claude-seo" run pagespeed_check.py URL --json
...
```bash
"./.claude/skills/seo/bin/claude-seo" run pagespeed_check.py URL --json
"./.claude/skills/seo/bin/claude-seo" run crux_history.py URL --json
```
