...
- Fetch the target URL using `"./.claude/skills/seo/bin/claude-seo" run render_page.py "<url>" --mode auto --json` (SPA-aware SSRF-protected renderer)
- Parse with `"./.claude/skills/seo/bin/claude-seo" run parse_html.py --url "<url>"` to extract SEO elements
