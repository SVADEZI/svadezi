...
```bash
"./.claude/skills/seo/bin/claude-seo" run capture_screenshot.py URL --all --output screenshots/
"./.claude/skills/seo/bin/claude-seo" run render_page.py URL --mode auto --a11y-tree --json
```
